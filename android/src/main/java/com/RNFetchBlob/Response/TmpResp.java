 ...
 */
public class TmpResp extends ResponseBody {
    ...
    public TmpResp(ReactApplicationContext ctx, String taskId, ResponseBody body, String path, boolean overwrite, String exceptionMessage) throws IOException {
        super();
        this.rctContext = ctx;
        this.mTaskId = taskId;
